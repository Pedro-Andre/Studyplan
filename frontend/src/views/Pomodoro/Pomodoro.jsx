  ...
  return (
    <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
      <div style={S.header}>
        ...
        <p style={S.subtitle}>É hora de focar e fazer o que precisa ser feito!</p>
      </div>

      <div style={S.outer}>
        {/* botão de configuração */} 
        <button style={S.settingsBtn} onClick={() => {
          ...
          <div style={S.settingsMenu}>
            <label style={S.settingsLabel}>
              ...
              <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                <button
                  style={S.adjustBtn}
                  onClick={() => setTempCustomTimer((prev) => Math.max(1, prev - 10))}
                >
                  -10
                </button>
                <input
            ...
            <label style={{ ...S.settingsLabel, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
              Alarme:
              <input
                type="checkbox"
                checked={tempAlarmOn}
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10 }}>
              <button style={S.resetBtnSettings} onClick={handleResetSettings}>Redefinir</button>
              <button style={S.saveBtnSettings} onClick={handleSaveSettings}>Salvar</button>
            </div>
          </div>
        )}
        ...
        <div style={S.modeBar}>
          <button
            style={mode === "timer" ? { ...S.modeBtn, ...S.selectedBtn } : S.modeBtn}
            onClick={() => switchMode("timer")}
          >
            Timer
          </button>
          <button
            style={mode === "interval" ? { ...S.modeBtn, ...S.selectedBtn2 } : S.modeBtn}
        ...
        <div style={S.circleContainer}>
          ...
          <div style={{
            ...
            <button style={S.playBtn} onClick={isRunning ? pause : startOrRestart}>
              {!isRunning ? <span style={S.playIcon}>▶</span> : <span style={S.pauseIcon}>❚❚</span>}
            </button>
          </div>
        </div>
        ...
        {hasStarted && (
          <button onClick={reset} style={S.resetBtn}>Resetar</button>
        )}
      </div>
    </div>
  );
